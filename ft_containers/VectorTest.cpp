...
template <typename T>
static void print_all_origin_vector_element(std::vector<T> v)
{
...
template <typename T>
static void print_all_my_vector_element(ft::Vector<T> &v)
{
...
template <typename T>
static void print_both_vector(std::vector<T> ori_v, ft::Vector<T> &my_v)	// 와 인자로 그냥 my_v 넘기니 소멸자가 2번 호출 됨...
